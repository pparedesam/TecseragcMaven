 ...
 *
 */
@WebServiceClient(name = "billService", targetNamespace = "http://service.sunat.gob.pe", wsdlLocation = "https://ose.nubefact.com/ol-ti-itcpe/billService?wsdl")
public class BillService_Service
    ...
    static {
        ...
        try {
            url = new URL(Connect.Instancia().getConnectOSE());
        } catch (MalformedURLException ex) {
            e = new WebServiceException(ex);
        } catch (Exception ex) {
            Logger.getLogger(BillService_Service.class.getName()).log(Level.SEVERE, null, ex);
        }
