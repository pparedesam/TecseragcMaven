 ...
 * @author RenRio
 */
public class sEncargado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet sEncargado</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet sEncargado at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (action.equalsIgnoreCase("buscarEncargadoBien")) {
                buscarEncargadoBien();
            }
    ...
    private void buscarEncargadoBien() throws Exception {

        String valor = varRequest.getParameter("txtNomEncar");
        List<Empleado> listaEncargado = EmpleadoNEG.Instancia().obtenerEncargadoBien(valor);
        dataObject.clear();
        dataObject.put("Result", "OK");
        dataObject.put("listaencargado", listaEncargado);
