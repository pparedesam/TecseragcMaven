...
public class sDownload extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet sDownload</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet sDownload at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String file = request.getParameter("idFact");
        String filepath = "";
        PrintWriter out = response.getWriter();
        String filename = "20315295573-" + file + ".xml";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (action.equalsIgnoreCase("descargarXML")) {
                descargarXML();
            }
    ...
    private void descargarXML() throws IOException {

        varResponse.setContentType("text/html");
        String file = varRequest.getParameter("idFact");
        String filepath = "";
