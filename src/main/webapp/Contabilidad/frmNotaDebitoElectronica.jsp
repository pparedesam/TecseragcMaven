...
<div class="row">
    <div class="col-md-12" style="text-align: left">
        <legend class="text-success"><b>NOTA DEBITO</b></legend>
    </div>
</div>

<div class="row" >
    <div class="col-md-102 well" style="background-color: #FFF;">
        <ul class="nav nav-tabs" id="tabNotaDebito">
            <li role="presentation" class="active"><a href="#Busqueda">B&Uacute;SQUEDA DE NOTAS</a></li>
            <li role="presentation"><a href="#nuevaNotaDebito">NUEVA NOTA D&Eacute;BITO</a></li>
        </ul>
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="Busqueda">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-2">
                            <select class='simple-select form-control' data-style='btn-default' name='cboBusqueda' id='cboBusqueda'>
                                <option value="2">NOTA D&Eacute;BITO</option>
                                <option value="1">FECHA</option>
                            </select>                
                        </div>
                        <div class="col-md-8" id="busquedaNroFactura">
                            <input type="text" class="form-control text-uppercase" name="txtBusquedaNroNotaDebito" id="txtBusquedaNroFactura" autocomplete="off" maxlength="50" style="display: block;"/>
                        </div>
                        ...
                        <div class="col-md-2">
                            <button class="btn btn-success col-md-12" name="btnBuscarNotaDebito" id="btnBuscarNotaDebito" title="Buscar nota debito"><i class="fa fa-search" aria-hidden="true" ></i>&nbsp; BUSCAR</button> 
                        </div>
                    </div>
                </div>
                <hr/>
                <div class="row">
                    <div id="divTablaBienes" class="col-md-12"> 
                        <table class="table table-striped table-bordered table-hover" id="tblNotasDebito" name="tblNotasDebito">
                            <thead>
                                <tr>
                                    <th>Nro Documento</th>
                                    <th>Ejecutor</th>
            ...
            <div role="tabpanel" class="tab-pane" id="nuevaNotaDebito">
                <br>
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-2 col-md-offset-5">
                            <button class="btn btn-success col-md-12" name="btnRegistrarNotaDebito" id="btnRegistrarNotaDebito" title="Registrar Nota D&eacute;bito"><i class="fa fa-save" aria-hidden="true" ></i>&nbsp; Registrar Nota D&eacute;bito</button> 
                        </div>
                    </div>
                </div>
            </div>
...
<script src="<c:url value="/resources/js/jsContabilidad/jsNotaDebito/jsNotaDebito.js"/>" type="text/javascript"></script>
<script src="<c:url value="/resources/js/jsContabilidad/jsNotaDebito/jsNotaDebitoTable.js"/>" type="text/javascript"></script>
