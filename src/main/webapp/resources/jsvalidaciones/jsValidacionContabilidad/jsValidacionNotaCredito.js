        ...
        rules:
                {
                    ...
                    txtIGV: {min: 0.01},
                    txtTotal: {min: 0.01},
                    txtFactura: {required: true, minlength: 12},
                    cboTipoNota: {valueNotEquals: "default"
                    }, txtDetalleMotivo: {required: true, minlength: 5},
                },
        messages:
                {
                    ...
                    txtFactura: {required: "Debe ingresar un numero de documento", minlength: "EL numero de documento debe tener 12 numeros"},
                    cboTipoNota: {valueNotEquals: "Seleccione un tipo de Nota de Credito!"},
                    txtDetalleMotivo: {required: "Debe ingresar un motivo para la nota de credito", minlength: "debe tener como minimo 5 caracteres"},
                }
    });
