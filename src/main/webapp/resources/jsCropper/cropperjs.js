    ...
    Cropper.prototype = {
        ...
        limitCropBox: function (isSizeLimited, isPositionLimited) {
            ...
            if (isSizeLimited) {
                ...
                if (cropperBandera == 1) {
                    cropBox.minWidth = 200;
                    cropBox.minHeight = 300;
                    cropBox.maxWidth = 200;
                    cropBox.maxHeight = 300;
                } else if (cropperBandera == 2) {

                    cropBox.minWidth =300;
                    cropBox.minHeight = 200;
                    cropBox.maxWidth = 300;
                    cropBox.maxHeight = 200;
                } else
                {
