        ...
        ClientPrintJobGroup.prototype._generateDataAsync = function () {
            ...
            return new Promise(function (resolve, reject) {
                ...
                Promise.all(promises).then(function (data_arr) {
                    ...
                    var jobs = data_arr.reduce(function (prev, curr) {
                        return new Blob([prev, curr]);
                    });
...
(function (JSPM) {
    ...
    var InstalledPrinter = (function () {
        function InstalledPrinter(printerName, printToDefaultIfNotFound, trayName, paperName, duplex) {
            if (printToDefaultIfNotFound === void 0) {
            ...
            if (duplex === void 0) {
                duplex = JSPM.DuplexMode.Default;
            }
            this.Id = 1;
            this._name = "";
                                    ...
                                    if (json.connection == 'CONNECTED') {
                                        ...
                                        _this.send(JSON.stringify({url: JSPM.JSPrintManager.license_url}), {
                                            ...
                                            on_update: function (v) {
                                                console.info("JSPrintManager License:", 'result' in v ? v['result'] : v);
                                            },
                                            on_error: function (v) {
                                                console.warn("JSPrintManager License:", 'result' in v ? v['result'] : v);
                                            },
                                        });
...
(function (JSPM) {
    var JSPrintManager = (function () {
        ...
        JSPrintManager.getPrintersInfo = function (detail_level, printer_name) {
            var _this = this;
            if (detail_level === void 0) {
                detail_level = JSPM.PrintersInfoLevel.Basic;
            }
        ...
        JSPrintManager.onPrinterCreated = function (callback, error, detail_level) {
            if (detail_level === void 0) {
                detail_level = JSPM.PrintersInfoLevel.Extended;
            }
            ...
            return new Promise(function (ok, err) {
                switch (_this.fileContentType) {
                    ...
                    case JSPM.FileSourceType.URL:
                        ...
                        break;
                    default:
                        err('FileSourceType not specified');
                }
            });
        };
            ...
            return new Promise(function (ok, err) {
                switch (_this.fileContentType) {
                    ...
                    case JSPM.FileSourceType.URL:
                        ...
                        break;
                    default:
                        err("The file content type is invalid");
                }
            });
        };
        return PrintFile;
...
(function (JSPM) {
    var PrintFileTXT = (function (_super) {
        ...
        function PrintFileTXT(fileContent, fileName, copies, fileContentType) {
            ...
            fileContent, fileContentType ? fileContentType : JSPM.FileSourceType.BLOB, fileName.substring(0, fileName.lastIndexOf('.')) + '.wtxt', copies) || this;
            _this.textContent = '';
            _this.textAligment = JSPM.TextAlignment.None;
            _this.fontName = 'Calibri';
            ...
            _this.printOrientation = JSPM.PrintOrientation.Landscape;
            _this.marginLeft = 0;
            _this.marginRight = 0;
            _this.marginTop = 0.2;
            _this.marginBottom = 0;
            //_this.printRotation = JSPM.PrintRotation.Rot270;
            return _this;
        }
        PrintFileTXT.prototype.serialize = function () {
            ...
            return new Promise(function (ok, err) {
                var SEP = '|';
                _this.getBLOBContent().then(function (file_content) {
                    var params = new Uint8Array(JSPM.Utils._str2UTF8Array(
                            //_this.fileContentType + SEP +
                            _this.printOrientation + SEP +
                            //_this.printRotation + SEP +
                            _this.textAligment + SEP +
                            _this.fontName + SEP + _this.fontSize + SEP +
