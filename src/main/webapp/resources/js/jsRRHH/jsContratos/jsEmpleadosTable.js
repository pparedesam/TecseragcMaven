...
var obtenerContratosEmpleado = function (idPersona) {
    ...
    var success = function (res) {
        ...
        if (res.Result == 'OK') {
            ...
            if (res.ContratosEmpleado.objContratoActual.fecInicio == undefined) {
                ...
                listarBancos(res.ContratosEmpleado.objEmpleado.Banco.IdBanco);
                ...
                listarOficinas(res.ContratosEmpleado.objContratoActual.oficina.idOficina);
                listarDpto(res.ContratosEmpleado.objContratoActual.oficina.idOficina, res.ContratosEmpleado.objContratoActual.area.codigo);

                listarPuestoDptoOficina(res.ContratosEmpleado.objContratoActual.area.codigo, res.ContratosEmpleado.objContratoActual.oficina.idOficina, res.ContratosEmpleado.objContratoActual.puesto.idPuesto)
                
                //listarCargos(res.ContratosEmpleado.objContratoActual.objCargo.idCargo);
                listarTipoContrato(res.ContratosEmpleado.objContratoActual.tipoContrato);
                ...
                if(Sab=='0'){
                    ...
                    listarHorarioSabado('SI');
                    $("#TipoHorarioSabado").css("display", "block");
                    $("#horarioSabado").css("display", "block");
                }
                listarGrupoHorarioLunVie(ofi,LunVie);
                listarGrupoHorarioSabado(ofi,Sab);
                //validarFecha();
            }
    ...
    fn_callmethod("../sContrato?action=obtenerContratosEmpleado", data, success, error);
};
