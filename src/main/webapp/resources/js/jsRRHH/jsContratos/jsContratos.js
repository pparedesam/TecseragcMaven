...
$(document).ready(function (event) {
    ...
    $('#cboOficina').change(function () {
        listarDpto($('#cboOficina').val(), '01');
        var ofi=$('#cboOficina').val();
        listarGrupoHorarioLunVie(ofi,'0');
        listarGrupoHorarioSabado(ofi,'0');
        listarHorarioSabado('NO');
        $("#TipoHorarioSabado").css("display", "none");
        $("#horarioSabado").css("display", "none");
    });
    $('#cboDepartamento').change(function () {
        listarPuestoDptoOficina($('#cboDepartamento').val(), $('#cboOficina').val(), '0');
    });
...
$('#btnNuevoEmpleado').click(function (event) {
    ...
    listarOficinas('01');
    listarDpto('01', '01');
    listarPuestoDptoOficina('01', '01', '01');
    $("#txtFecInicio").val('');
    $("#txtSalInicial").val('0');
    $("#txtFecFinal").val('');
    $("#txtSalFinal").val('0');
    ...
    //listarCargos('0');
    listarTipoContrato('PLAZO DETERMINADO');
    $('#divFecFinal').css("display", "inline-table");
    $('#txtIndeterminado').css("display", "none");
    ...
    var ofi=$("#cboOficina").val();
    listarGrupoHorarioLunVie('01','0');
    listarGrupoHorarioSabado('01','0');
    listarHorarioSabado('NO');
    $("#TipoHorarioSabado").css("display", "none");
    $("#horarioSabado").css("display", "none");
    var fec = new Date();
...
$('#btnCancelar').click(function (event) {
    ...
    obtenerContratosEmpleado(idPersona);
...
var finContratoEmpleado = function (idPersona, fecFinal, motSalida) {
    ...
    fn_callmethod("../sContrato?action=finContratoEmpleado", data, success, error);
}
...
var registarEmpleado = function (idPersona, Banco, AFP, NroCuenta, CodigoAFP, EPS, PlanEPS, TipoComision, ESSALUD, NroHijos, puesto, departamento,  tipContrato, oficina, fecInicio, fecFinal, salActual, Fiscalizado, LunVie, Sab) {
    ...
    fn_callmethod("../sContrato?action=registarEmpleado", data, success, error);
}
...
var actualizarContratoEmpleado = function (idPersona, Banco, AFP, NroCuenta, CodigoAFP, EPS, PlanEPS, TipoComision, ESSALUD, NroHijos,  tipContrato, fecFinal, salActual, Fiscalizado, LunVie, Sab) {
    ...
    fn_callmethod("../sContrato?action=actualizarContratoEmpleado", data, success, error);
}
...
var agregarContratoEmpleado = function (idPersona, puesto, departamento,  tipContrato, oficina, fecInicio, fecFinal, salActual) {
    ...
    fn_callmethod("../sContrato?action=agregarContratoEmpleado", data, success, error);
}
...
var listarOficinas = function (select) {
    $('#cboOficina').empty();
    var success = function (res) {
        if (res.Result == 'OK') {
...
var listarGrupoHorario = function () {
    var success = function (res) {
        if (res.Result == 'OK') {
            listaHorario='';
...
var listarGrupoHorarioLunVie = function (oficina,selectLunVie) {
    $('#cboHorario').empty();
...
var listarGrupoHorarioSabado = function (oficina,selectSab) {
...
var listarHorarioSabado = function (select) {
...
var listarTipoContrato = function (select) {
...
var listarBancos = function (select) {
...
var listarDpto = function (idOficina, select) {
...
var listarPuestoDptoOficina = function (idDpto, idOficina, select) {
...
var desbloquearControles = function () {
...
var bloquearControles = function () {
