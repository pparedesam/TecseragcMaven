...
<div class="row">
    <div class="col-md-6 col-md-offset-3">
        <center><legend class="text-success">CONTRATOS DE COLABORADOR</legend></center>   
    </div>
</div>
            ...
            <div class="col-md-10 col-md-offset-1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="col-sm-4" style="margin-right: 10px" id="NuevoEmpleado" style="display: none;" >
                                <button class="btn btn-success" type="button" name="btnNuevoEmpleado" id="btnNuevoEmpleado" title='Nuevo Colaborador'><i class="fa fa-plus" aria-hidden="true"></i>&nbsp; Nuevo Colaborador</button>
                            </div>
                ...
                <div class="row">
                    <div class="panel panel-primary" id="panelEmpleadoSinContrato" style="display: none;">
                        <div class="panel-heading"><h2><b>Datos Colaborador - Contrato Actual</b></h2></div>
...
<script src="<c:url value="/resources/js/jsRRHH/jsContratosColaboradores/jsContratosColaboradores.js"/>" type="text/javascript"></script>
<script src="<c:url value="/resources/js/jsRRHH/jsContratosColaboradores/jsColaborador.js"/>" type="text/javascript"></script>

<script src="<c:url value="/resources/js/jsRRHH/jsContratosColaboradores/jsColaboradorTable.js"/>" type="text/javascript"></script>
