...
<div class="row">
    <div class="col-md-10 col-md-offset-1" style="text-align: left">
        <legend class="text-success"><b>GU&Iacute;A DE REMISI&Oacute;N MANUAL</b></legend>
    </div>
</div>
...
<script src="<c:url value="/resources/js/jsLogistica/jsGuiaRemision/jsGuiaRemisionManual.js"/>" type="text/javascript"></script>
<script src="<c:url value="/resources/js/jsLogistica/jsGuiaRemision/jsGuiaRemisionTableManual.js"/>" type="text/javascript"></script>
<script src="<c:url value="/resources/jsvalidaciones/jsValidacionLogistica/jsValidacionGuiaRemision.js"/>"
